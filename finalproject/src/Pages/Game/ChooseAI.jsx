    ...
    >
      ...
      <div className="flex flex-col gap-6 w-80">
        ...
        <button
          ...
          className="w-full py-4 bg-red-600 rounded-full text-xl font-semibold transition duration-300 hover:bg-red-700 shadow-md"
        >
          Siêu Khó
        </button>
      </div>
      ...
      {selectedMode && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-md animate-fadeIn">
          <div className="bg-[#f7e3c4] p-6 rounded-xl shadow-xl text-center w-96 border border-gray-300">
            ...
            <div className="flex justify-center gap-6">
              <button
                ...
                className="flex items-center gap-3 px-8 py-4 bg-gray-900 text-white rounded-full text-2xl font-semibold border-4 border-transparent hover:border-gray-600 hover:scale-105 transition duration-300 shadow-lg"
              >
                Đen
              </button>
              <button
                onClick={() => handleColorSelect("red")}
                className="flex items-center gap-3 px-8 py-4 bg-red-600 text-white rounded-full text-2xl font-semibold border-4 border-transparent hover:border-red-400 hover:scale-105 transition duration-300 shadow-lg"
              >
                Đỏ
              </button>
            </div>
